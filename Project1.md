### Project Goal
#
# To Deploy a LAMP Stack Website on AWS Cloud
...
to update and upgrade each out-dated dependencies and packages in my server..
...
### STEP 1
   ...
   I installed MySQL in my Ubuntu terminal by running the command
...
After installing the configuration, I hit the “esc” button and type “:wq” and “enter” to save and exit the file.
  Then I ran the command
   ...
   to check if the directory is configured.
...
### STEP 2
 ...
 And I disabled the default website that comes installed with Apache by running  
...
### STEP 3
   ...
   to check that the configuration file doesn’t contain any syntax error
And run 

        “sudo systemctl reload apache2” 
to reload and make the changes to take effect.
